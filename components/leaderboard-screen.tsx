  ...
  return (
    <div className="pb-24 px-4 space-y-6">
      ...
      <div className="flex items-end justify-center gap-3 pt-4">
        {/* Second Place */}
        {topThree[1] && (
          <div className="flex flex-col items-center flex-1 max-w-[8rem]">
            ...
            <div className="w-full h-20 bg-card rounded-t-xl border-2 border-b-0 border-border flex flex-col items-center justify-center px-2 gap-0.5">
              <span className="text-lg font-bold text-muted-foreground">2</span>
              <span className="text-xs font-semibold text-card-foreground truncate w-full text-center">{topThree[1].user.name}</span>
        ...
        {/* First Place */}
        {topThree[0] && (
          <div className="flex flex-col items-center flex-1 max-w-[9rem] -mt-5">
            ...
            <div className="w-full h-24 bg-primary/20 rounded-t-xl border-2 border-b-0 border-primary flex flex-col items-center justify-center px-2 gap-0.5">
              <span className="text-2xl font-bold text-primary">1</span>
              <span className="text-xs font-semibold text-foreground truncate w-full text-center">{topThree[0].user.name}</span>
        ...
        {topThree[2] && (
          <div className="flex flex-col items-center flex-1 max-w-[8rem]">
            ...
            <div className="w-full h-16 bg-card rounded-t-xl border-2 border-b-0 border-border flex flex-col items-center justify-center px-2 gap-0.5">
              <span className="text-md font-bold text-muted-foreground">3</span>
              <span className="text-xs font-semibold text-card-foreground truncate w-full text-center">{topThree[2].user.name}</span>
              <span className="text-xs font-bold text-muted-foreground">
